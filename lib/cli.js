...
var Proxy = /** @class */ (function () {
    ...
    Proxy.pipe = function (req, res) {
        ...
        var headers = req.headers, method = req.method, url = url_1.default.resolve(proxyPath, req.url);
        var options = {
            method: method,
...
function pipe(req, res, options_, remoteUrl, redirects) {
    ...
    var remote = url_1.default.parse(remoteUrl), options = {}, isCachable = CacheHelper.isCachable(req);
...
function locationNormalize(location, req) {
    if (location[0] === '/') {
        location = path_1.default.join(proxyPath, location);
    }
