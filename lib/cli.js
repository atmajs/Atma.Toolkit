...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_action_init != null ? _src_action_init : {};
    var module = { exports: exports };
...
exports.InitAction = {
    ...
    process: function (config, done) {
        return __awaiter(this, void 0, void 0, function () {
            var packageChanged, dirSource;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ensureJson('./package.json', packageJson)];
                    case 1:
                        packageChanged = _a.sent();
                        if (!packageChanged) return [3 /*break*/, 3];
                        return [4 /*yield*/, (0, shellbee_1.run)('npm i')];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [4 /*yield*/, ensureJson('./tsconfig.json', tsconfigJson)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, ensureJson('./typings.json', typingsJson)];
                    case 5:
                        _a.sent();
                        dirSource = atma_io_1.env.applicationDir.combine('./template/init/');
                        return [4 /*yield*/, atma_io_1.Directory.copyToAsync(dirSource.toString(), atma_io_1.env.currentDir.toString())];
                    case 6:
                        _a.sent();
                        done(null);
                        return [2 /*return*/];
            ...
            for (var key in source) {
                ...
                if (Array.isArray(val) && val.length > 0) {
                    ...
                    if (Array.isArray(targetArr) === false) {
                        throw new Error("Target value in ".concat(key, " is not an array"));
                    }
                ...
                if (typeof val === 'object') {
                    if (typeof target[key] !== 'object') {
                        throw new Error("Target value in ".concat(key, " is not an object"));
                    }
                    var $modified = extendWithDefaultValues(target[key], val);
                    modified = $modified || modified;
                }
            }
            return modified;
        }
        var file, pckg, exists, modified;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    file = new atma_io_1.File(path);
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    modified = extendWithDefaultValues(pckg, json);
                    if (!(exists === false || modified === true)) return [3 /*break*/, 5];
                    return [4 /*yield*/, file.writeAsync(pckg)];
                case 4:
                    _a.sent();
                    _a.label = 5;
                case 5: return [2 /*return*/, modified];
            }
        });
    });
}
...
;
    ...
    if (_src_action_init === module.exports) {
        // do nothing if
    } else if (__isObj(_src_action_init) && __isObj(module.exports)) {
        Object.assign(_src_action_init, module.exports);
    } else {
        _src_action_init = module.exports;
    }
...
exports.Server = {
    start: function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var appConfig, port, proxyPath, proxyOnly, proxyFollowRedirects, singlePage, atmaConfigsPath, base, configs, app, bodyParser, Url, responders, server, sslPort, keyFile, certFile, options, serverCfg, handlers, pages, websockets, subapps;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        appConfig = global.app.config;
                        port = config.port || process.env.PORT || 5777, proxyPath = config.proxy, proxyOnly = config.proxyOnly, proxyFollowRedirects = config.followRedirects, singlePage = config.singlePage;
                        atmaConfigsPath = new atma_utils_1.class_Uri(location)
                        ...
                        configs = [atmaConfigsPath];
                        if (config.config) {
                            configs.push(config.config);
                        }
                        return [4 /*yield*/, atma_server_1.Application.create({
                                configs: configs,
                                config: {
                                    debug: true,
                    ...
                    case 1:
                        ...
                        bodyParser = require('body-parser'), Url = require('url');
                        responders = [];
                        if (proxyOnly !== true) {
                        ...
                        server = require('http')
                            ...
                            .listen(port);
                        if (config.sslPort) {
                            sslPort = config.sslPort, keyFile = config.key, certFile = config.cert;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, server_1.Server.start(config)];
                    case 1:
                        _b.sent();
                        if (config.open) {
...
var Application = /** @class */ (function (_super) {
    ...
    Application.prototype.findAction = function (action) {
        ...
        var mix = this.config.actions[action];
