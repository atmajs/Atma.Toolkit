void function(){
    ...
    w.Resource = Class({
        //Base: Include,
        Construct: function(includeData, parent  /*type, url, uri, namespace, parent*/) {
            var
                _type = includeData.type,
        ...
        onload: function(source) {
            ...
            case 'js':
                ...
                var includes = w.parser[this.type].extractIncludes(source, solution.directory);
                
                r.arr.each(includes, function(x){
                    this.includes.push(new Resource(x, this));
                }.bind(this));
